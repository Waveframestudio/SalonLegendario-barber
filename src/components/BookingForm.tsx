  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center p-3 sm:p-4 z-50">
      <div className="bg-gray-900 border border-gray-700 rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 max-w-md w-full shadow-2xl max-h-[90vh] overflow-y-auto">
        ...
        {/* Summary card */}
        <div className="bg-gray-800/50 border border-gray-700 rounded-xl sm:rounded-2xl p-3 sm:p-4 mb-4 sm:mb-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 sm:pl-10 pr-10 py-2.5 sm:py-3 bg-gray-800 border border-gray-700 text-white rounded-lg sm:rounded-xl focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500 hover:border-amber-500/60 transition-all duration-200 placeholder-gray-500 text-sm sm:text-base"
              ...
              {additionalNames.map((name, idx) => (
                <div key={idx} className="relative mt-2">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-9 py-2.5 bg-gray-800 border border-gray-700 text-white rounded-lg sm:rounded-xl focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500 hover:border-amber-500/60 transition-all duration-200 placeholder-gray-500 text-sm"
          ...
          <div className="flex flex-row items-center justify-center gap-3">
            <button
              ...
              className="px-5 py-2 bg-gradient-to-r from-amber-600 to-yellow-500 text-black rounded-lg hover:from-amber-500 hover:to-yellow-400 transition-all duration-200 font-semibold text-sm disabled:opacity-70 disabled:cursor-not-allowed shadow-md shadow-amber-500/20"
            >
